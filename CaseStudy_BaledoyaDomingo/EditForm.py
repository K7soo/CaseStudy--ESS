...
class EditForm:
    def __init__(self, edit, manipulate_db):
        ...
        self.headingLabel = tk.Label(self.window, text="S T U D E N T   F O R M",
    ...
    def create_widgets(self):
        ...
        self.tree = ttk.Treeview(self.table_frame,
                                 columns=("StudentID", "StudentFirstName", "StudentLastName", "Course", 
        ...
        # Information #
        tk.Label(self.info1_frame, text="Course:", bg="#bebebe").grid(row=0, column=0)
        ...
        self.course_combobox = ttk.Combobox(self.info1_frame, values=["BSIT", "BSCS"], textvariable=self.course)
    ...
    def add_row(self):
        ...
        self.db.add_to_database(self.student_number.get(), self.first_name.get(), self.last_name.get(),
                                self.course.get(), self.year.get(), self.grades.get(), self.selected_status)
        self.populate_table()
        self.clear_fields()
    ...
    def update_row(self):
        ...
        self.course.set(student_data[3])
    ...
    def update_selected_row(self):
        ...
        updated_course = self.course.get()
        updated_year = self.year.get()
        updated_grades = self.grades.get()
        # updated_status = self.status.get()
        ...
        self.tree.set(selected_item, "Course", updated_course)
